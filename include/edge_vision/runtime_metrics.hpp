...
struct RuntimeOutputMetrics {
    ...
    std::uint64_t event_clip_events_skipped_capacity{0};
    std::uint64_t event_clip_events_skipped_queue{0};
    std::uint64_t event_clip_events_skipped_worker_queue{0};
    std::size_t event_clip_pending_jobs_high_watermark{0};
    std::uint64_t event_clip_queue_wait_samples{0};
    double event_clip_queue_wait_total_ms{0.0};
    double event_clip_queue_wait_max_ms{0.0};
    std::uint64_t event_clip_events_completed{0};
    std::uint64_t event_clip_events_shared{0};
    bool event_clip_share_overlap{false};
    double event_clip_max_shared_seconds{10.0};
    ...
    std::string event_clip_encoder{"disabled"};
    std::uint32_t event_clip_bitrate_kbps{0};
    std::size_t event_clip_capacity{0};
