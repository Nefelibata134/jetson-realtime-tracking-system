             ...
             {"event_clips",
              {
                  ...
                  {"encoder", outputs.event_clip_encoder},
                  {"bitrate_kbps", outputs.event_clip_bitrate_kbps},
                  {"capacity", outputs.event_clip_capacity},
                  ...
                  {"events_skipped_capacity", outputs.event_clip_events_skipped_capacity},
                  {"events_skipped_queue", outputs.event_clip_events_skipped_queue},
                  {"events_skipped_worker_queue", outputs.event_clip_events_skipped_worker_queue},
                  {"pending_jobs_high_watermark", outputs.event_clip_pending_jobs_high_watermark},
                  {"queue_wait_samples", outputs.event_clip_queue_wait_samples},
                  {"queue_wait_total_ms", outputs.event_clip_queue_wait_total_ms},
                  {"queue_wait_max_ms", outputs.event_clip_queue_wait_max_ms},
                  {"events_completed", outputs.event_clip_events_completed},
                  {"events_shared", outputs.event_clip_events_shared},
                  {"share_overlap", outputs.event_clip_share_overlap},
                  {"max_shared_seconds", outputs.event_clip_max_shared_seconds},
                  {"max_shared_events", outputs.event_clip_max_shared_events},
                  {"frames_encoded",
